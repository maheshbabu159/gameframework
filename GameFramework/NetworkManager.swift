...
class NetworkManager: NSObject {
    ...
    class func getRequestObject(apiMethod:NSString, bodyData:NSString)-> NSMutableURLRequest {
        ...
        var remoteUrl : NSURL? = NSURL(string: GlobalVariables.request_url + apiMethod)
                    ...
                    if let rootDictionary = jsonDictionary as? [String: AnyObject] {
                        ...
                        if let resultString:NSString = rootDictionary["result"] as? NSString {
                            ...
                            if(resultString.isEqualToString("Invalid Credentials")){
                                ...
                                let alertController = UIAlertController(title:"Executive Dashboard", message:resultString
                                ...
                                if let sessionId:NSString = rootDictionary["result"] as? NSString{
                                    ...
                                    self.getProfileDataServiceCall("GetProfile", bodyData: jsonString, viewController: viewController)
            ...
            NSURLConnection.sendAsynchronousRequest(NetworkManager.getRequestObject(apiMethod, bodyData:bodyData ), queue: NSOperationQueue.mainQueue(), completionHandler:{
                ...
                if((resstr) != nil){
                    ...
                    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)) {
                        ...
                        self.getWebSiteVisitsServiceCall("GetWebsiteVisits", bodyData: resstr!, viewController: viewController)
            ...
            NSURLConnection.sendAsynchronousRequest(NetworkManager.getRequestObject(apiMethod, bodyData:bodyData ), queue: NSOperationQueue.mainQueue(), completionHandler:{
                ...
                if((resstr) != nil){
                    ...
                    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)) {
                        ...
                        self.getRevenueServiceCall("GetRevenue", bodyData: resstr!, viewController: viewController)
            ...
            NSURLConnection.sendAsynchronousRequest(NetworkManager.getRequestObject(apiMethod, bodyData:bodyData ), queue: NSOperationQueue.mainQueue(), completionHandler:{
                ...
                if((resstr) != nil){
                    ...
                    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0)) {
                        ...
                        self.getProjectsServiceCall("GetActiveProjects", bodyData: resstr!, viewController: viewController)
                        ...
                        if let resultString:NSString = rootDictionary["result"] as? NSString {
                            ...
                            if(resultString.isEqualToString("Invalid Password") || resultString.isEqualToString("Invalid Session")){
                                ...
                                if let messsage:NSString = rootDictionary["result"] as? NSString{
                                    ...
                                    let alertController = UIAlertController(title:"Executive Dashboard", message:messsage
                                        , preferredStyle: UIAlertControllerStyle.Alert)
